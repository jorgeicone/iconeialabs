...
const QS = [
 ...
 {
  "d": 2,
  "q": "Cuando necesitas resolver una duda de normativa aduanera, una partida arancelaria, un incoterm o un procedimiento interno, ¿cómo lo resuelves hoy?",
  "o": [
   "Le pregunto a un compañero o al agente de aduana",
   "Busco en Google y de vez en cuando le pregunto a una IA",
   "Le pregunto a la IA para orientarme y después confirmo",
   "Uso IA con búsqueda de fuentes y contrasto contra la norma o el documento oficial"
  ]
 },
 {
  "d": 2,
  "q": "¿Usas IA para resumir documentos largos: contratos con proveedores, pliegos, normativa, manuales de producto?",
  "o": [
 ...
 {
  "d": 2,
  "q": "Cuando una IA te entrega un dato —un tiempo de tránsito, un requisito de importación, una partida— ¿qué haces antes de usarlo?",
  "o": [
   "Lo uso tal como viene",
   "Le doy una leída rápida por encima",
   "Lo verifico cuando algo me suena raro",
   "Siempre lo contrasto con la fuente antes de tomar una decisión"
  ]
 },
 {
  "d": 2,
  "q": "La información que necesitas para trabajar —inventarios, estados de pedido, tiempos de proveedor, documentos de importación— hoy está…",
  "o": [
   "Dispersa: entre correos, Excel y lo que cada quien sabe",
 ...
 {
  "d": 2,
  "q": "¿Usas IA para preparar resúmenes de estado o presentaciones de indicadores para tu jefe o para el comité?",
  "o": [
 ...
 {
  "d": 3,
  "q": "¿Usas IA para redactar los textos de tu cargo: correos a proveedores y agentes de aduana, respuestas a clientes por estado de pedido, respuestas a PQR?",
  "o": [
 ...
 {
  "d": 3,
  "q": "¿Usas IA para construir tablas de seguimiento, cronogramas de embarque, comparativos de proveedores o el contenido de una presentación?",
  "o": [
   "Nunca, eso lo armo a mano en Excel",
 ...
 {
  "d": 4,
  "q": "¿Tienes claro qué tareas tuyas se repiten igual cada semana (seguimiento de pedidos, informe de agotados, cruce de inventarios)?",
  "o": [
 ...
 {
  "d": 4,
  "q": "¿Usas IA para armar los informes de seguimiento que entregas cada semana o cada mes?",
  "o": [
 ...
 {
  "d": 5,
  "q": "El conocimiento de tu área —procedimientos, incoterms, condiciones de cada proveedor, respuestas frecuentes a clientes— hoy está…",
  "o": [
 ...
 {
  "d": 5,
  "q": "¿Usas plantillas para lo que se repite (correos de seguimiento, formatos de reclamo a proveedor, respuestas a PQR, informes de estado)?",
  "o": [
 ...
 {
  "d": 5,
  "q": "¿Se te ocurren tareas de tu área que un agente de IA podría hacer de principio a fin (avisar de un embarque atrasado, responder el estado de un pedido, alertar un quiebre de stock)?",
  "o": [
 ...
 {
  "d": 6,
  "q": "¿Tienes claro qué información de tu área NO debería salir hacia una herramienta externa (costos de importación, condiciones negociadas con proveedores, datos de clientes)?",
  "o": [
 ...
 {
  "d": 6,
  "q": "Cuando una respuesta hecha con ayuda de IA sale hacia un cliente, un proveedor o la aduana, ¿cuánto la revisas antes?",
  "o": [
   "No he estado en esa situación",
   "Le doy una leída rápida y la mando",
   "La reviso, sobre todo las fechas y las cantidades",
   "La reviso completa: respondo yo por lo que sale con mi nombre"
  ]
 },
 {
  "d": 6,
 ...
 {
  "d": 6,
  "q": "Cuando manejas datos de clientes o de proveedores —contactos, direcciones de entrega, precios negociados— ¿qué cuidado tienes al usar una herramienta de IA?",
  "o": [
   "No lo había pensado",
   "Lo pienso, pero no sé bien qué debería hacer",
   "Evito pegar lo más obvio, como bases de datos completas",
...
const CTX = {
 "tareas": [
  "Seguimiento a pedidos y órdenes de compra con proveedores",
  "Pronóstico de demanda y plan de abastecimiento",
  "Seguimiento a importaciones y coordinación con el agente de aduana",
  "Revisión de documentos de comercio exterior (facturas, BL, declaraciones)",
  "Control de inventarios y revisión de quiebres de stock",
  "Responder a clientes por estado de pedidos",
  "Atender PQR y reclamos",
  "Cruzar información entre sistemas o archivos de Excel",
  "Informes de indicadores: cumplimiento, tiempos de tránsito, agotados",
  "Correos y llamadas de coordinación con otras áreas",
  "Documentar procedimientos y trazabilidad",
  "Cotizar fletes, transporte o servicios logísticos"
 ],
 "frenos": [
...
const ACCIONES = {
 "1": "Tome el seguimiento semanal de pedidos y resuélvalo con IA, para ver con las manos dónde ayuda y dónde estorba.",
 "2": "Resuelva con fuentes verificadas la última duda de partida arancelaria o de incoterm que le tocó consultar.",
 "3": "Escriba el prompt del correo al agente de aduana y el de la respuesta a PQR, y guárdelos para reutilizarlos.",
 "4": "Cronometre el cruce de inventarios o el informe de agotados, y rediséñelo para que tome la mitad de los pasos.",
 "5": "Monte un asistente con los procedimientos, los incoterms y las respuestas frecuentes a clientes ya cargados.",
 "6": "Escriba en una hoja qué costos de importación y qué datos de clientes no salen del área, y déjela pegada al puesto."
};
