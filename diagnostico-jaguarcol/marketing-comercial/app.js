/* ═══════════════════════════════════════════════════════════════
   ...
   MARKETING · DESARROLLO · COMERCIAL — JaguarCol
...
const AREA = {
  ...
  "nombre": "Marketing, Desarrollo y Comercial",
  "tag": "MARKETING · DESARROLLO · COMERCIAL",
  "subareas": [
    "Diseño",
    "Marketing",
    "Producto",
...
const QS = [
 ...
 {
  "d": 2,
  "q": "Cuando necesitas investigar la competencia, un mercado, una tendencia o la especificación de un producto, ¿cómo lo resuelves hoy?",
  "o": [
   "Busco en Google y reviso lo que aparezca",
   "Busco en Google y de vez en cuando le pregunto a una IA",
   "Le pregunto a la IA para orientarme y después confirmo",
   "Uso IA con búsqueda de fuentes y contrasto contra la fuente original"
  ]
 },
 {
  "d": 2,
  "q": "¿Usas IA para resumir documentos largos: pliegos de un cliente, informes de mercado, contratos, manuales técnicos?",
  "o": [
 ...
 {
  "d": 2,
  "q": "Cuando una IA te entrega un dato —una cifra de mercado, una característica de producto, un precio de referencia— ¿qué haces antes de usarlo?",
  "o": [
   "Lo uso tal como viene",
   "Le doy una leída rápida por encima",
   "Lo verifico cuando algo me suena raro",
   "Siempre lo contrasto con la fuente antes de que salga hacia un cliente"
  ]
 },
 {
  "d": 2,
  "q": "La información que necesitas para trabajar —portafolio, precios, historial de clientes, resultados de campañas— hoy está…",
  "o": [
 ...
 {
  "d": 2,
  "q": "¿Usas IA para preparar resúmenes o presentaciones de resultados para tu jefe, para el comité o para un cliente?",
  "o": [
 ...
 {
  "d": 3,
  "q": "Si lo que te devuelve no sirve —el copy suena plano, la propuesta queda genérica— ¿qué haces?",
  "o": [
   "No la uso",
   "Me rindo y termino haciéndolo a mano",
   "Vuelvo a preguntar, a ver si sale mejor",
   "Corrijo la instrucción por partes hasta que suena como nosotros"
  ]
 },
 {
  "d": 3,
 ...
 {
  "d": 3,
  "q": "¿Usas IA para redactar los textos de tu cargo: propuestas comerciales, correos de seguimiento, copys, briefs, respuestas a clientes?",
  "o": [
   "Nunca, todo lo escribo yo",
   "Lo probé una vez",
   "A veces, para arrancar el borrador",
   "Sí, es mi punto de partida habitual y luego le doy mi tono"
  ]
 },
 {
  "d": 3,
  "q": "¿Usas IA para construir tablas comparativas, cronogramas de campaña, fichas de producto o el contenido de una presentación?",
  "o": [
   "Nunca, eso lo armo a mano",
 ...
 {
  "d": 4,
  "q": "¿Tienes claro qué se repite igual en cada campaña, cada cotización o cada requerimiento que atiendes?",
  "o": [
   "Nunca me he puesto a listarlo",
   "Lo tengo en la cabeza, no escrito",
   "Lo tengo listado en alguna parte",
   "Listado, y sé cuánto tiempo me consume cada cosa"
  ]
 },
 {
  "d": 4,
  "q": "¿Sabes cuántas horas a la semana te consume tu tarea más repetitiva?",
  "o": [
 ...
 {
  "d": 4,
  "q": "¿Usas IA para armar los reportes recurrentes que entregas (ventas, campañas, pipeline, tickets)?",
  "o": [
 ...
 {
  "d": 5,
  "q": "El conocimiento de tu área —portafolio, precios, tono de marca, objeciones frecuentes, manuales— hoy está…",
  "o": [
 ...
 {
  "d": 5,
  "q": "¿Usas plantillas para lo que se repite (propuestas, correos de seguimiento, fichas, formatos de requerimiento)?",
  "o": [
   "Cada vez lo escribo desde cero",
   "Copio y pego de la última que hice",
 ...
 {
  "d": 5,
  "q": "¿Se te ocurren tareas de tu área que un agente de IA podría hacer de principio a fin (responder primeras consultas, armar el borrador de una cotización, hacer seguimiento a un cliente frío)?",
  "o": [
 ...
 {
  "d": 6,
  "q": "¿Tienes claro qué información de tu área NO debería salir hacia una herramienta externa (bases de clientes, listas de precios, material sin lanzar, código o accesos)?",
  "o": [
 ...
 {
  "d": 6,
  "q": "Cuando algo hecho con ayuda de IA sale publicado o llega a un cliente, ¿cuánto lo revisas antes?",
  "o": [
   "No he estado en esa situación",
   "Le doy una leída rápida y lo mando",
   "Lo reviso, sobre todo los datos y los precios",
   "Lo reviso completo: respondo yo por lo que sale con la marca"
  ]
 },
 {
  "d": 6,
 ...
 {
  "d": 6,
  "q": "Cuando manejas datos de clientes —nombres, contactos, historial de compra, condiciones negociadas— ¿qué cuidado tienes al usar una herramienta de IA?",
  "o": [
   "No lo había pensado",
   "Lo pienso, pero no sé bien qué debería hacer",
   "Evito pegar lo más obvio, como bases de contactos",
...
const CTX = {
 "tareas": [
  ...
  "Seguimiento a clientes y oportunidades en el CRM",
  "Redactar copys, correos y contenidos para redes",
  "Diseñar y ajustar piezas gráficas",
  "Adaptar una misma pieza a varios formatos o canales",
  "Armar briefs y coordinar con proveedores o agencias",
  "Fichas técnicas y material de producto",
  "Investigación de competencia, mercado y precios",
  "Reportes de ventas, campañas o indicadores",
  "Atender requerimientos y tickets de soporte interno",
  "Documentar procesos, manuales o requerimientos de sistemas",
  "Preparar presentaciones para clientes o para comité"
 ],
 "frenos": [
...
const ACCIONES = {
 "1": "Tome un brief o una ficha de producto y rehágalo con IA, para ver con las manos dónde ayuda y dónde estorba.",
 "2": "Investigue a un competidor con fuentes verificadas, en vez de con lo primero que aparezca en el buscador.",
 "3": "Escriba el prompt de la propuesta comercial y el del correo de seguimiento, con el tono de la marca dentro.",
 "4": "Cronometre lo que tarda en adaptar una pieza a todos los formatos, y monte el flujo que lo haga por usted.",
 "5": "Monte un asistente con el portafolio, los precios y las objeciones frecuentes ya cargados.",
 "6": "Escriba en una hoja qué datos de clientes y qué material sin lanzar no salen del área, y déjela pegada al puesto."
};
